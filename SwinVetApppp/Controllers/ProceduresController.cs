...
namespace SwinVetApppp.Controllers
{
    public class ProceduresController : Controller
    {
        ...
        {
            var treatments = db.Treatments.Include(b => b.Owner).Include(b => b.Pet).Include(b => b.Procedure);
            if (treatments == null)
            {
                return HttpNotFound();
            }
            treatments = treatments.Where(x => x.ProcId == id);
        ...
        public ActionResult Create([Bind(Include = "ProcId,Description,Price")] Procedure procedure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProcId,Description,Price")] Procedure procedure)
        {
            if (ModelState.IsValid)
            {
